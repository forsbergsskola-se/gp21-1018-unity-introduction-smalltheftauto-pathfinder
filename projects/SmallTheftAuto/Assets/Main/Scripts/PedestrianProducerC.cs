...
public class PedestrianProducerC : MonoBehaviour
{
    public bool shouldSpawn;
    public PedestrianC[] trafficPrefabs;
    ...
    public void SpawnTraffic(bool shouldSpawn) {
        if(shouldSpawn) {
            player = GameObject.FindGameObjectWithTag("PTargetC");
        }
    ...
    void spawnTraffic() {
        ...
        var newTraffic = Instantiate(trafficPrefabs[index], randomSpawnPosition(), Quaternion.identity) as PedestrianC;
