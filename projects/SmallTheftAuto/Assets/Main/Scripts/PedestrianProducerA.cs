...
public class PedestrianProducerA : MonoBehaviour
{
    public bool shouldSpawn;
    public PedestrianA[] trafficPrefabs;
    ...
    public void SpawnTraffic(bool shouldSpawn) {
        if(shouldSpawn) {
            player = GameObject.FindGameObjectWithTag("PTargetA");
        }
    ...
    void spawnTraffic() {
        ...
        var newTraffic = Instantiate(trafficPrefabs[index], randomSpawnPosition(), Quaternion.identity) as PedestrianA;
