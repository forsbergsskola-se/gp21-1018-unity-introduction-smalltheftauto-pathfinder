...
public class PedestrianProducerB : MonoBehaviour
{
    public bool shouldSpawn;
    public PedestrianB[] trafficPrefabs;
    ...
    public void SpawnTraffic(bool shouldSpawn) {
        if(shouldSpawn) {
            player = GameObject.FindGameObjectWithTag("PTargetB");
        }
    ...
    void spawnTraffic() {
        ...
        var newTraffic = Instantiate(trafficPrefabs[index], randomSpawnPosition(), Quaternion.identity) as PedestrianB;
